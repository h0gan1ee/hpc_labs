...
void SLIC::RGB2XYZ(
	...
	double &Z)
{
	// auto rgb = simd_make_double3(sR, sG, sB);

	// auto M = simd_matrix_from_rows(
	// 	simd_make_double3(0.412453, 0.357580, 0.180423),
	// 	simd_make_double3(0.212671, 0.715160, 0.072169),
	// 	simd_make_double3(0.019334, 0.119193, 0.950227));

	// auto xyz = simd_mul(M, rgb);
